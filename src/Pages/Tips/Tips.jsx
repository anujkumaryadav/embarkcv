    ...
    return(
      ...
      <AccordionItem className="border-b border-gray-200 py-[17px] dark:!border-white/10">
          ...
          <AccordionPanel
            ...
            pb={4}
          >
            <p>1. Contact Information: Include your name, phone number, email address, and professional social media profile if you have one.</p>
            <p>2. Objective or Summary: This section should briefly describe your career goals and highlight your relevant skills and experience.</p>
            <p>3. Education: List your educational qualifications in reverse chronological order, including your degree, institution, and graduation date.</p>
            <p>4. Work Experience: List your work experience in reverse chronological order, including your job title, company name, employment dates, and key responsibilities and achievements.</p>
            <p>5. Skills: List any relevant skills you have, including technical skills, language proficiency, or soft skills like communication and teamwork.</p>
            <p>6. Certifications and Licenses: If you have any relevant certifications or licenses, include them in this section.</p>
            <p>7. Awards and Honors: If you have received any awards or honors related to your education or work experience, include them in this section.</p>
            <p>8. Extracurricular Activities: Include any relevant extracurricular activities or volunteer work that demonstrate your skills and interests.</p>
            <p>9. References: You can list references on your resume, but it's not mandatory. You can also say "References available upon request."</p>
          </AccordionPanel>
        </AccordionItem>{" "}
        ...
        <AccordionItem className="border-b border-gray-200 py-[17px] dark:!border-white/10">
          ...
          <AccordionPanel
            ...
            pb={4}
          >
            <p>1. Use a clean and professional layout: Your resume should be easy to read, so use a clean font and avoid using too many colors or images.</p>
            <p>2. Use bullet points: Use bullet points to organize your information and make it easy to read. This also helps highlight your key achievements and responsibilities.</p>
            <p>3. Keep it concise: Try to keep your resume to one or two pages maximum. Be selective about what information you include and focus on the most relevant details.</p>
            <p>4. Use clear section headings: Use clear section headings to organize your information, such as "Education," "Work Experience," and "Skills."</p>
            <p>5. Include white space: Use white space between sections and bullet points to make your resume easier to read and less cluttered.</p>
            <p>6. Use keywords: Use keywords from the job posting to help your resume get past automated resume scanners and show that you have the required skills and experience.</p>
            <p>7. Save as a PDF: Save your resume as a PDF file to ensure that the formatting stays the same across different devices and operating systems.</p>
          </AccordionPanel>
        </AccordionItem>{" "}
