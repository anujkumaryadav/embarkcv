...
const Theme2 = (props) => {
    ...
    const { name, address, phone, email, linkedin, github, profile, profileImage, summary, skill } = themeData.personalData;
                    ...
                    <section className='partition-1'>
                        <Box>
                            ...
                            <Box className='mt-3'>
                                ...
                                <Heading fontSize='md' className='my-2'>Github</Heading>
                                <Text fontSize={'sm'}>{github}</Text>
                                <Heading fontSize='md' className='my-2'>LinkedIn</Heading>
